...
- [`RFC-0003: Pre-authority API Quarantine and Boundary Hardening`](RFC-0003-security-review-api-quarantine.md) — accepted 2026-07-12 by Dana Edwards after two independent technical reviews and explicit maintainer semantic approval; fixes positive v1 quantities, lifecycle maximum one, API quarantine, typed resource-ID derivation, and diagnostic redaction. Its implementation remains pre-alpha and grants no policy, verifier, state, commit, release, or production authority.
