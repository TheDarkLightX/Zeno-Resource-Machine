...
pub use opaque::{
    ...
    ResourceId, ResourceKindId, ResourceKindPolicySetRoot, ResourceLogicId, ResourceNonce,
    StatementHash, StatementSchemaRoot, SupportedResourceSchemaRoot, SupportedTransitionSchemaRoot,
