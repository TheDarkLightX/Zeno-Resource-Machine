...
unapproved_design_scope = RFC-0001 and RFC-0002 semantic-closure package
...
The repository contains two unapproved Class E semantic-closure RFCs and one accepted pre-authority hardening RFC. RFC-0001 and RFC-0002 cover policy suspension, authority-context freshness, acyclic semantic-effect commitment, linearizable retry classification, uncertain commit outcomes, and serialized recursive journal composition; they still require explicit maintainer decisions. RFC-0003 is accepted and governs the positive-quantity, lifecycle-maximum, API-quarantine, typed resource-ID, and diagnostic-redaction rules described above. See [`rfcs/README.md`](rfcs/README.md) and the [`semantic-closure review package`](formal/state-machine/semantic_closure_v1/README.md).
